...
function VerClase() {
  ...
  const handleDownload = () => {
    ...
    const filteredData = asistenciaQuery.data.filter((clase) => clase.data().idClase === idClase);

    console.log(filteredData); // Agrega esta línea
    ...
    const data = filteredData.map(clase => {
      ...
      return {
        ...
        '% de inasistencias': (claseData.inasistencias*100)/claseData.totalClases,
      };
    });
